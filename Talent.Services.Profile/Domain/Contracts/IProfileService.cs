...
namespace Talent.Services.Profile.Domain.Contracts
{
    public interface IProfileService
    {
        ...
        Task<IEnumerable<TalentSuggestionViewModel>> GetFullTalentList(int position, int increment);
        Task<TalentSuggestionViewModel> TalentSuggestionViewModel(User talent);
