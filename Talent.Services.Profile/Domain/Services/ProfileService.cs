...
namespace Talent.Services.Profile.Domain.Services
{
    public class ProfileService : IProfileService
    {
            ...
            if (profile != null)
            {
                ...
                foreach (var item in talentList)
                {
                    ...
                    if (item.Experience != null && item.Experience.Count > 0)
                    {
                        ...
                        level = item.Experience.First().Position;
                    }
        ...
        public async Task<IEnumerable<TalentSuggestionViewModel>> GetFullTalentList(int position, int increment)
        {
            //Your code here;
            try
            {
                //var talents = _userRepository.GetQueryable().ToList();
            ...
            catch (Exception ex)
            {
                ...
                //throw;
                return await GetFullTalentList(position + increment, increment);
            }
